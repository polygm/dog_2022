...
*/
  ...
  angle1 = 95;
  pulse1 = map(angle1, 0, 180, USMIN, USMAX);
  pulse4 = map(180 - angle1, 0, 180, USMIN, USMAX);
  pwm.writeMicroseconds(servo_fl_1, pulse1);
  pwm.writeMicroseconds(servo_fr_1, pulse4);
  pwm.writeMicroseconds(servo_bl_1, pulse4);
  pwm.writeMicroseconds(servo_br_1, pulse1);
